...
print(desiredFile) #confirms input of desiredFile by printing it out
print(trials) #confirms input of trials by printing it out

txtFileClear =  open("C:/SciFair/txtFiles/" + "Python" + desiredFile + ".txt", "w") #opens the file as writable in order to clear the file if it already exists
...
txtFile = open("C:/SciFair/txtFiles/" + "Python" + desiredFile + ".txt", "a") #opens the file as appendable so more data can be added
