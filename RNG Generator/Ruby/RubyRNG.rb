...
puts desiredFile #confirms input of desiredFile by printing it out
puts trials #confirms input of trials by printing it out

File.write("C:/SciFair/txtFiles/" + "Ruby" + desiredFile + ".txt", "") #opens the file and writes to the file in order to clear the file if it already exists
file = File.open("C:/SciFair/txtFiles/" + "Ruby" + desiredFile + ".txt", mode: "a") #opens the file as appendable so more data can be added
